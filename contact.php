        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="top-one">
              <ul>
                <li>
                  <i class="fa-sharp fa-regular fa-phone-volume"></i><a href="tel:+966548187650">+966 54 818 7650
                  </a>
                </li>
                <li>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link line" aria-current="page" href="index.html">Home</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="drop-main" id="box">
                ...
                <li class="nav-drp">
                  <a href="project-photos.html">Project Photos</a>
                </li>
              </ul>
            </li>
            <!-- <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link active line-one" href="contact.php">Contact Us</a>
            </li>
          </ul>
          <!-- <button class="button-56" role="button">Contact Us</button> -->
        </div>
      </div>
    </nav>
  </div>

  <div class="banner tin-banner">
    <div class="container">
      <div class="header-content">
        ...
        <!-- <p>
            ...
            within the Kingdom. In particular, our collaboration with <span>VARIANT
              FORMWORKS - UKRAINE</span> has positioned us as formidable competitors in the
            Scaffolding & Formworks sector.
          </p> -->
        <ul>
          <li>
            <a href="index.html"><i class="fa-regular fa-house"></i>Home</a>
          </li>
          <li>
    ...
    <div class="inner-about">
      <div class="container">
        ...
        <p>
          ...
          FORMWORKS - UKRAINE has positioned us as formidable competitors in the
          Scaffolding & Formworks sector.
        </p>
      </div>
    </div>
      ...
      <div class="row justify-content-center">
        <div class="col-md-10">
          <div class="about-text">
            <h4>
              <i class="fa-regular fa-user-helmet-safety"></i> CONTACT US
            </h4>
            <h2>
        ...
        <div class="col-lg-5 col-md-12">
          <div class="get-info">
            ...
            <div class="com-info">
              ...
              <div class="inf-get">
                <p>Call Us</p>
                <a href="tel:+966548187650" class="font-b">
                  +966 54 818 7650</a>
              </div>
            </div>
            ...
            <div class="com-info">
              ...
              <div class="inf-get">
                <p>Write to Us</p>
                <a href="mailto:sales@wsarabia.com" class="font-b">sales@wsarabia.com</a>
              </div>
            </div>
            ...
            <div class="com-info">
              ...
              <div class="inf-get">
                <p>Head Office:</p>
                <a href="#" class="font-b">Najf Commercial Center Baladiyah Street, Jeddah 23334
        ...
        <div class="row">
          ...
          <!-- <div class="col-lg-3 col-md-6">
            <div class="foot-box ">
              ...
              <ul>
                <li>
                  <a href="electrolytic-tin-plate.html"><i class="fa-solid fa-angles-right"></i> Electrolytic Tin
                    Plate</a>
                </li>
                <li>
                  <a href="tin-free-steel.html"><i class="fa-solid fa-angles-right"></i> Tin Free Steel</a>
                </li>
                <li>
                  <a href="cold-rolled-grain-steel.html"><i class="fa-solid fa-angles-right"></i> Cold Rolled Oriented
                    Electrical
                    Steel</a>
                </li>
                <li>
                  <a href="hot-rolled-steel.html"><i class="fa-solid fa-angles-right"></i> Hot Rolled Steel</a>
                </li>
                <li>
                  <a href="cold-rolled-steel.html"><i class="fa-solid fa-angles-right"></i> Cold Rolled Steel</a>
                </li>
              </ul>
            </div>
          </div> -->
            ...
            <div class="foot-box foot-text">
              ...
              <ul class="list">
                <li>
                  ...
                  <a href="#">
                    Najf Commercial Center Baladiyah Street, Jeddah 23334
                    Kingdom of Saudi Arabia</a>
                </li>
              </ul>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="foot-box foot-text">
              ...
              <ul>
                ...
                <li>
                  <a href="about.html"><i class="fa-solid fa-angles-right"></i> About Us</a>
                </li>

                <li>
                  <a href="scaffolding-and-formwork.html"><i class="fa-solid fa-angles-right"></i>Scaffolding &
                    Formworks</a>
                </li>
                <li>
                  <a href="ferro-alloys-and-minerals.html"><i class="fa-solid fa-angles-right"></i> Ferro Alloys And
                    Minerals</a>
                </li>
                <li>
                  <a href="ductile-iron-pipes.html"><i class="fa-solid fa-angles-right"></i>Ductile Iron
                    Pipes</a>
                </li>
                <li>
                  <a href="fencing-works.html"><i class="fa-solid fa-angles-right"></i>Fencing Works</a>
                </li>
                <li>
                  <a href="contact.php"><i class="fa-solid fa-angles-right"></i> Contact Us</a>
                </li>
              </ul>
            </div>
          </div>
